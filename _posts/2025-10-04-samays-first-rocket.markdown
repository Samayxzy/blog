...
*Black coroplast sign board
Plastic Champagne glasses
Gas Relief Pills
150 Grit Sandpaper 
400 Grit Sandpaper
Players Gear Golf Tubes
Wrapping paper:
Epoxy Glue:
Hot Glue Gun:
...
![MR #1 Nose Cone ](/assets/images/posts/samays-rocket-project-1/mr-1-nose-cone.jpeg) 

To secure the nose cone to the body, I used a pill bottle as the transition. I cut off the base and used a flat metal file to remove the treads from the bottles neck. Then, I sanded down the rest of the bottle for a clean finish. 

Image ⬇️

![MR #1 Transition](/assets/images/posts/samays-rocket-project-1/mr-1-transition.jpeg) 

To test it, I connected the pill bottle transition to the rocket body and attached the nose cone on top. It fit tight enough to stay on during flight, but easy to remove if needed.
...
![MR #1 Full rocket](/assets/images/posts/samays-rocket-project-1/mr-1-full-rocket.jpg) 

My friend, who helped with the project, built a simple launch pad. It consisted of a wooden slab with a long metal rod screwed in. It could definitely use some improvement in the future, but for this launch, it worked well. For the launch lugs, I cut up a pen and glued the pieces onto small strips of sign board to keep the rocket in place during launch.

![MR #1 Inside](/assets/images/posts/samays-rocket-project-1/mr-1-inside.png) 
...
It worked perfectly. As soon as the circuit was complete, the igniter heated up enough to launch the rocket.
...
Out of curiosity, I decided to try a second launch without reattaching the missing fin. The rocket still flew well. This time it took off in a spiral pattern, but it stayed mostly stable and barely drifted while flying. 
